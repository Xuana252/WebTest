...
const Gallery = ({ photos }) => {
  ...
  return (
    <ul className={`grid ${gridColStyle} gap-x-2 bg-primary min-h-screen min-w-full gap-2 p-5 justify-center absolute top-[110px] transition ease-in-out duration-300 `}>
